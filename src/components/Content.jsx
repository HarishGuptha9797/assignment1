            ...
            <div>
                <div className="content">
                    <div className="ad-image">
                        <img src="\public\\images\pexels-canva-studio-3153201 1.png" />
                    ...
                    <div className="teams">
                        {[
                            {class : 'Front-end',src:"public\\images\\monitor.png",text:'Our frontend developers understand the delicate balanace between aesthetics and functionality.'},
                            {class :'Back-end',src:'public\\images\\simcard.png',text:'Our backend developers are the architects of efficiency and security. They design and build the databases and APIs.'},
                            {class :'Data-Analytics',src:'public\\images\\driver.png',text:'Our data analysts team is a blend of mathematicians, statisticians, and technology enthusiasts.'},
                        ].map((value)=>{
                            return(
                        ...
                        <div className="back-end">
                            <img src="public\\images\simcard.png" />
                        ...
                        <div className="data-analytics">
                            <img src="public\\images\driver.png" />
                    ...
                    <div className="services">
                        {[
                            ...
                            {   
                                src:'public\\images\\setting-5.png',
                                name:'QA and Testing',
                                diffStyles:{textDecorationColor:'gray'},
                                text:'Create custom software tailored for your unique needs, including front-end, and core back-end technology.',
                        ...
                        {/* <div class='service1'>
                            <img src="public\\images\document-code.png"/>
